import { useLoaderData, useActionData, Form, Link, useNavigate } from "react-router";
import { toast } from "sonner";
import type { Route } from "./+types/dashboard.pacientes.$id.editar";
      ...
      <Form method="post" className="space-y-6">
        ...
        <div className="flex gap-3">
          ...
          <Button type="button" variant="outline" asChild>
            <Link to={PATHS.patientProfile(patient.id)}>Cancelar</Link>
          </Button>
        </div>
      </Form>
    </div>
