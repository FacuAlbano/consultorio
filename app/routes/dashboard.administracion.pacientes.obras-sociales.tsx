...
export default function ObrasSociales() {
  ...
  React.useEffect(() => {
    ...
    if (actionData.success) {
      if (actionData.actionType === INSURANCE_COMPANY_ACTIONS.CREATE) toast.success("Obra social creada correctamente");
      else if (actionData.actionType === INSURANCE_COMPANY_ACTIONS.UPDATE) toast.success("Obra social actualizada correctamente");
      else if (actionData.actionType === INSURANCE_COMPANY_ACTIONS.DELETE) toast.success("Obra social eliminada correctamente");
